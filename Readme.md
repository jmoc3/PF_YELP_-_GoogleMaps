...
**Específicos:**    
    1. Confeccionar un dashboard en base a los KPIs seleccionados. <br>
    2. Hacer uso de los servicios cloud de Google para mayor eficiencia de  los procesos internos. <br>  
    3. Disponibilizar de manera diversa la extracción de los datos. <br>
